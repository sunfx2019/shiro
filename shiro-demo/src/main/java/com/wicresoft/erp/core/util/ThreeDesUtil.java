...
public class ThreeDesUtil {
	...
	public static void main(String[] args) {
		try{
			//加密
			String ciphertext = ThreeDesUtil.getInstance().encrypt("073188992648forenetf8ssc", "88992648", "123456789");
			System.out.println(ciphertext);
			//解密
			System.out.println(ThreeDesUtil.getInstance().decrypt("073188992648forenetf8ssc", "88992648", "1a00977856604c975d5d42626fea208e"));
		}catch(Exception e){
			e.printStackTrace();
		}
	}
